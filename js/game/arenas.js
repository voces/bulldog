...
new Arena({
    ...
    entities: {
        ...
        TinyFarm: [
            {x: -4 * scale + nudgeW, y: nudgeH},
            // {x: -23 * scale + nudgeW, y: 5 * scale + nudgeH},
            // {x: -23 * scale + nudgeW, y: 3 * scale + nudgeH},
            // {x: -23 * scale + nudgeW, y: 1 * scale + nudgeH},
            // {x: -21 * scale + nudgeW, y: 1 * scale + nudgeH},
            // {x: -19 * scale + nudgeW, y: 1 * scale + nudgeH},
            // {x: -17 * scale + nudgeW, y: 1 * scale + nudgeH},
            // {x: -23 * scale + nudgeW, y: -1 * scale + nudgeH},
            // {x: -21 * scale + nudgeW, y: -1 * scale + nudgeH},
            // {x: -19 * scale + nudgeW, y: -1 * scale + nudgeH},
            // {x: -17 * scale + nudgeW, y: -1 * scale + nudgeH},
            // {x: -23 * scale + nudgeW, y: -3 * scale + nudgeH},
            // {x: -21 * scale + nudgeW, y: -3 * scale + nudgeH},
            // // {x: -19 * scale + nudgeW, y: -3 * scale + nudgeH},
            // {x: -17 * scale + nudgeW, y: -3 * scale + nudgeH},
            // {x: -23 * scale + nudgeW, y: -5 * scale + nudgeH},
            // {x: -21 * scale + nudgeW, y: -5 * scale + nudgeH},
            // {x: -19 * scale + nudgeW, y: -5 * scale + nudgeH},
            // {x: -17 * scale + nudgeW, y: -5 * scale + nudgeH},
            // {x: -23 * scale + nudgeW, y: -7 * scale + nudgeH},
            // {x: -21 * scale + nudgeW, y: -7 * scale + nudgeH},
            // {x: -19 * scale + nudgeW, y: -7 * scale + nudgeH},
            // {x: -23 * scale + nudgeW, y: -9 * scale + nudgeH},
            // {x: -21 * scale + nudgeW, y: -9 * scale + nudgeH},
            // {x: -19 * scale + nudgeW, y: -9 * scale + nudgeH},
        ],
